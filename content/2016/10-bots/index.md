...
So here's my take: I process the input file, execute the first type of instructions immediately and put others in the queue.
Then I iterate over the instruction queue until it's empty: if the bot is ready, the command is executed and removed from the queue.
